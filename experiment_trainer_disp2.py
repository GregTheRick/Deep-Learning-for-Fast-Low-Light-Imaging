...
#Set up experiments
expList = []
expList.append(Experiment(name='deep_isp2_noflip',model_fn={'fn':ModelBuilder.build_deep_isp_exp2},device="/device:GPU:0",tensorboard_dir=tensorboard_dir,checkpoint_dir=checkpoint_dir))
